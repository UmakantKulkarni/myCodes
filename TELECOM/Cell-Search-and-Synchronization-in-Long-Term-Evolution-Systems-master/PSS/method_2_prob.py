...
from other_functions import dft, idft, cir_corr, sequence_amplitude
import random

def method_2(num_trials, standard_deviation):
    count = 0
    N_ZC = 63 
    u = [25, 29, 34]
