...
from other_functions import dft, idft, cir_corr, sequence_amplitude, dtft
...
c1 = cir_corr(zc_t,zc_t0)
c1 = sequence_amplitude(c1)
c2 = cir_corr(zc_t,zc_t1)
c2 = sequence_amplitude(c2)
c3 = cir_corr(zc_t,zc_t2)
...
l = ['u = 25', 'u = 29', 'u = 34']
t = 'PSD for AWGN with $\sigma$ = '+str(standard_deviation)+' (u = '+str(choice)+')'
