  ...
  public static void main(String args[]) throws java.io.IOException {
    ...
    do {
      ...
      if (length2 == 1) {
        ...
        inChar = expr.charAt(0) ;      
          ...
          switch (inChar) {
            case '1':
              ...
              for (int i = 0; i < 10; i++) {
                int iCube = i * i * i;
                System.out.println("The number is = "+ i +" ; The Cube of the number is = "+ iCube);
                sumCube += iCube; 
              }
        ...
        if ("ukul".equals(expr)) {
          System.out.println("Password Accepted"); //Bonus Part - Compare the input string with the Password
        } else if ("".equals(expr)) {
